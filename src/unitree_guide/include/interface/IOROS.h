...
ros::Subscriber _walk_sub;
ros::Subscriber _balanced_stand_sub;
...
void walkCallback(const unitree_guide::Command &msg);
void BalancedStandCallback(const unitree_guide::Command &msg);
