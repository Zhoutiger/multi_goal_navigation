...
// std::cout << "Body frame, feetPos: " << std::endl << feetPos << std::endl;
// std::cout << "RotMat: " << std::endl << (state.getRotMat()) << std::endl;
...
A1Robot::A1Robot(){
    ...
    // _footPlaceLimit << -0.30, 0.30;
    // _robVelLimitX << -0.6, 0.6;
    _robVelLimitX << -0.8, 0.8;
    _robVelLimitY << -0.3, 0.3;
    _robVelLimitYaw << -1.2, 1.2;
