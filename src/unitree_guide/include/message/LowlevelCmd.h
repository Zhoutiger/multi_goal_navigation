...
struct LowlevelCmd{
    ...
    // unsigned int wirelessRemote[40];
    ...
    void setStableGain(int legID){
        // motorCmd[legID*3+0].mode = 10;
        // motorCmd[legID*3+0].Kp = 0.1;
        // motorCmd[legID*3+0].Kd = 0.1;
        // motorCmd[legID*3+1].mode = 10;
        // motorCmd[legID*3+1].Kp = 0.1;
        // motorCmd[legID*3+1].Kd = 0.1;
        // motorCmd[legID*3+2].mode = 10;
        // motorCmd[legID*3+2].Kp = 0.1;
        // motorCmd[legID*3+2].Kd = 0.1;
    ...
    void setSwingGain(int legID){
        ...
        // motorCmd[legID*3+0].mode = 10;
        // motorCmd[legID*3+0].Kp = 1;
        // motorCmd[legID*3+0].Kd = 0.3;
        // motorCmd[legID*3+1].mode = 10;
        // motorCmd[legID*3+1].Kp = 1;
        // motorCmd[legID*3+1].Kd = 0.3;
        // motorCmd[legID*3+2].mode = 10;
        // motorCmd[legID*3+2].Kp = 1;
        // motorCmd[legID*3+2].Kd = 0.3;
    }
};
